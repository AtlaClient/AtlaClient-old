...
void __fastcall TEditOrderAutoGiveForm::Action1Execute(TObject *Sender)
{
 edBegStr->SetFocus();
}
//---------------------------------------------------------------------------

void __fastcall TEditOrderAutoGiveForm::Action2Execute(TObject *Sender)
{
 edSubStr->SetFocus();
}
//---------------------------------------------------------------------------

void __fastcall TEditOrderAutoGiveForm::Action3Execute(TObject *Sender)
{
 cbItems->SetFocus();
}
//---------------------------------------------------------------------------
